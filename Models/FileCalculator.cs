...
namespace WebCalculator.Models
{
    public class FileCalculator : Calculator
    {
        ...
        {
            _expressions = test;
            _answerFilePath = null; // Инициализация значением по умолчанию
        }
        ...
        public string GetAnswerFilePath()
        {
            ...
            if (_answerFilePath == null)
                throw new InvalidOperationException("Answer file path is not set.");
